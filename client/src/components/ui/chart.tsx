...
// Chart color styles formerly required raw HTML injection. The current product does not render
// charts, so this intentionally remains inert until a future implementation can use vetted,
// static CSS classes rather than interpolating configuration into a style element.
